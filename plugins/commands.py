...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text=
f"<b>⚠️ ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴛʜɪs ʀᴜʟᴇs ⚠️</b>\n\n{message.from_user.mention}<b>ആദ്യം[【 ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 】](https://t.me/Vysakh_XD)എന്ന ബട്ടൺ ക്ലിക്ക് ചെയ്തു  ജോയിൻ റിക്വസ്റ്റ് ചെയ്.. എന്നിട്ട് വീണ്ടു ബോട്ടിൽ വന്നിട്ട്[【 ᴍᴇ ᴊᴏɪɴᴇᴅ 】](https://t.me/Vysakh_XD)എന്ന ബട്ടൺ ക്ലിക്ക് ചെയ്താൽ ഫയൽ കിട്ടുന്നതായിരിക്കും</b>\n\n<b>Fɪʀsᴛ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ[【 ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 】](https://t.me/Vysakh_XD)ʙᴜᴛᴛᴏɴ ᴀɴᴅ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ. ᴛʜᴇɴ ᴄᴏᴍᴇ ʙᴀᴄᴋ ᴛᴏ ᴛʜᴇ ʙᴏᴛ ᴄʟɪᴄᴋ ᴏɴ[【 ᴍᴇ ᴊᴏɪɴᴇᴅ 】](https://t.me/Vysakh_XD)ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ғɪʟᴇ...</b>"
