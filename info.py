...
API_ID = int(environ['6327652'])
API_HASH = environ['6c2ee4bf150d9f3cd3e3d64aad0772c8']
BOT_TOKEN = environ['6033779254:AAHcx18tGfGTTxZlm0zW-cixfM73Bm3c05Q']
...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/783a53b8ecdb7546990f3.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/451f038b4e7c2ddd10dc0.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/5e2d4418525832bc9a1b9.jpg")

# Admins, Channels & Users
support_chat_id = environ.get('SUPPORT_CHAT_ID')
SUPPORT_CHAT_ID = int(-912314397) if support_chat_id and id_pattern.search(support_chat_id) else None
ADMINS = [int(1055623367) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1001961012993', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(-1001501278428) if auth_channel and id_pattern.search(auth_channel) else None
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Malayalam_Cinema_Universe')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MalayalamCinemaUniverseofficial')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('-1001938222686', 0))
